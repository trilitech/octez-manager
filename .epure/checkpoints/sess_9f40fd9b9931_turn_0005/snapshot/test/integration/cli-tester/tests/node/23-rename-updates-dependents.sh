...
test_init "Renaming node updates dependent services"
...
# Register all instances for automatic cleanup (also pre-cleans leftovers)
register_instance "$BAKER_INSTANCE"
register_instance "$NEW_NODE_INSTANCE"
