...
module Op : sig
  ...
  val socket : t
  val uring_cmd : t
  val read_multishot : t
  val waitid : t
  val futex_wait : t
  val futex_wake : t
  val futex_waitv : t
  val fixed_fd_install : t
  val ftruncate : t
  val bind : t
  val listen : t
end = struct
  ...
  let socket = 0x2d
  let uring_cmd = 0x2e
  let read_multishot = 0x31
  let waitid = 0x32
  let futex_wait = 0x33
  let futex_wake = 0x34
  let futex_waitv = 0x35
  let fixed_fd_install = 0x36
  let ftruncate = 0x37
  let bind = 0x38
  let listen = 0x39
end
module Ioring_setup = struct
  let iopoll = 0x1
  let clamp = 0x10
  let r_disabled = 0x40
  let submit_all = 0x80
  let coop_taskrun = 0x100
  let taskrun_flag = 0x200
  let sqe128 = 0x400
  let cqe32 = 0x800
  let single_issuer = 0x1000
  let defer_taskrun = 0x2000
  let no_mmap = 0x4000
  let registered_fd_only = 0x8000
  let no_sqarray = 0x10000
end
module At = struct
