...
- OCaml 5.3.0 / Dune 3.20.2 + Cmdliner (CLI), Miaou TUI, Eio (concurrency), Alcotest (unit tests) (006-fix-cli-completion)
- N/A — no persistent state changes (006-fix-cli-completion)
