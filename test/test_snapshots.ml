...
let test_slug_shadownet () =
  let result = Snapshots.slug_of_network "shadownet" in
  check_string_opt "shadownet slug" (Some "shadownet") result
...
let slug_tests =
  [
    ...
    ("slug shadownet", `Quick, test_slug_shadownet);
