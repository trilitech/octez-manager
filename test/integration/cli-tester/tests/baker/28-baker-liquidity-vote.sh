...
test_init "Baker liquidity baking vote options"
...
register_instance "test-baker-lb-on"
register_instance "test-baker-lb-off"
register_instance "test-baker-lb-pass"
