...
let golden_path_script =
  ...
  (* Baker form: 16 fields + confirm. Cursor on field 0, need 16 Downs.
     Added "Remote Signer" field in PR #724, "Group" field for instance groups,
     and "Extra Nodes" field in PR #815 *)
  @ submit_form ~downs:16
  @ wait_for_sync_install
