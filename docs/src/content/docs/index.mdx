...
![Octez Manager TUI](../../assets/gifs/octez-manager.gif)
...
<div style="display: flex; align-items: center; justify-content: center; gap: 2rem; margin-top: 2rem; opacity: 0.8;">
  <span style="font-size: 0.9rem;">Developed by</span>
  <a href="https://www.nomadic-labs.com/" target="_blank" rel="noopener">
    <img src="../../assets/nomadic-labs-logo.png" alt="Nomadic Labs" style="height: 32px;" />
  </a>
  <span style="font-size: 0.9rem;">·</span>
  <span style="font-size: 0.9rem;">Hosted by <a href="https://trili.tech/" target="_blank" rel="noopener">Trilitech</a></span>
</div>
