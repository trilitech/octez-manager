...
- **Signatory keys display**: TUI instance details page now shows authorized signing keys for Signatory instances. Displays public key hashes (tz1/tz2/tz3/tz4) and allowed operations (block, attestation, etc.) in a dedicated "Authorized Keys" section below file paths.
