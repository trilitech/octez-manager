...
- **Version display**: `octez-manager --version` now reports the correct installed version (e.g. `0.3.0`) instead of the hardcoded string `0.2.1`. The version is now injected at build time via `dune-build-info`. (fixes #798)
